        ...
        <?php if($PESTAINFORME=="1"){ ?>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="listarDespachoexDetalladoExportacion.php">Detallado de exportacion <small class="badge bg-success" style="margin-left:6px; white-space:nowrap; display:inline-block;">Nuevo</small></i></a></li>
            </ul>
          </li>   
        <?php  } ?>
...
<script>
  (function () {
    if (!/\\/estadistica\\//.test(window.location.pathname)) {
      return;
    }
    if (localStorage.getItem("prefetch_despachoex_exportacion") !== "1") {
      return;
    }
    if (sessionStorage.getItem("prefetch_despachoex_exportacion_done") === "1") {
      return;
    }
    sessionStorage.setItem("prefetch_despachoex_exportacion_done", "1");
    fetch("listarDespachoexDetalladoExportacion.php?precarga=1", {
      credentials: "same-origin",
      keepalive: true
    }).catch(function () {
      sessionStorage.removeItem("prefetch_despachoex_exportacion_done");
    });
  })();
</script>
