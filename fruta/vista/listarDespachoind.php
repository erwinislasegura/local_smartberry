...
if ($_POST) {
    ...
    $detalleDespacho = $IDDESPACHO ? $DESPACHOIND_ADO->verDespachomp($IDDESPACHO) : [];
    ...
    if (isset($_REQUEST['SOLICITARELIMINAR'])) {
        if (!$IDDESPACHO) {
            ...
            $foliosDespacho = $EXIINDUSTRIAL_ADO->buscarPorDespacho($IDDESPACHO);

            if ($foliosDespacho) {
                $MENSAJE = "El despacho no puede eliminarse porque tiene folios industriales asociados.";
            } else {
                $codigoAutorizacion = generarCodigoAutorizacion();
                $_SESSION['DESPACHOIND_ELIMINAR_CODIGO'] = $codigoAutorizacion;
                $_SESSION['DESPACHOIND_ELIMINAR_ID'] = $IDDESPACHO;
                $_SESSION['DESPACHOIND_ELIMINAR_TIEMPO'] = time();
    ...
    if (isset($_REQUEST['CONFIRMAR_ELIMINAR'])) {
        $codigoSesion = $_SESSION['DESPACHOIND_ELIMINAR_CODIGO'] ?? null;
        $idSesion = $_SESSION['DESPACHOIND_ELIMINAR_ID'] ?? null;
        $tiempoSesion = $_SESSION['DESPACHOIND_ELIMINAR_TIEMPO'] ?? 0;
        $foliosDespacho = $IDDESPACHO ? $EXIINDUSTRIAL_ADO->buscarPorDespacho($IDDESPACHO) : [];

        if ($foliosDespacho) {
            $MENSAJE = "El despacho tiene folios industriales asociados y no puede ser eliminado.";
            ...
            $DESPACHOIND->__SET('ID_DESPACHO', $IDDESPACHO);
            $DESPACHOIND_ADO->deshabilitar($DESPACHOIND);
            ...
            unset($_SESSION['DESPACHOIND_ELIMINAR_CODIGO']);
            unset($_SESSION['DESPACHOIND_ELIMINAR_ID']);
            unset($_SESSION['DESPACHOIND_ELIMINAR_TIEMPO']);
        }
    }
    ...
    if (isset($_REQUEST['SOLICITAR_ABRIR'])) {
        if (!$IDDESPACHO) {
            ...
            $codigoAutorizacion = generarCodigoAutorizacion();
            $_SESSION['DESPACHOIND_ABRIR_CODIGO'] = $codigoAutorizacion;
            $_SESSION['DESPACHOIND_ABRIR_ID'] = $IDDESPACHO;
            $_SESSION['DESPACHOIND_ABRIR_TIEMPO'] = time();
    ...
    if (isset($_REQUEST['CONFIRMAR_ABRIR'])) {
        $codigoSesion = $_SESSION['DESPACHOIND_ABRIR_CODIGO'] ?? null;
        $idSesion = $_SESSION['DESPACHOIND_ABRIR_ID'] ?? null;
        $tiempoSesion = $_SESSION['DESPACHOIND_ABRIR_TIEMPO'] ?? 0;
        ...
        if (!$IDDESPACHO) {
            ...
            $DESPACHOIND->__SET('ID_DESPACHO', $IDDESPACHO);
            $DESPACHOIND_ADO->habilitar($DESPACHOIND);
            ...
            unset($_SESSION['DESPACHOIND_ABRIR_CODIGO']);
            unset($_SESSION['DESPACHOIND_ABRIR_ID']);
            unset($_SESSION['DESPACHOIND_ABRIR_TIEMPO']);
        }
    }
}
                ...
                <div class="modal-content">
                    ...
                    <form method="post">
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="URL" value="registroDespachoind">
                            <input type="hidden" name="URLO" value="listarDespachoind">
