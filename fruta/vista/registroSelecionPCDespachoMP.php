...
if (isset($id_dato) && isset($accion_dato) && isset($_SESSION['urlO'])) {
    ...
    $ARRAYDESPACHOMP=$DESPACHOMP_ADO->verDespachomp($IDP);    
    if($ARRAYDESPACHOMP){
                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Despacho MP</li>
                                            <li class="breadcrumb-item" aria-current="page">Despacho Materia Prima</li>
                                            <li class="breadcrumb-item" aria-current="page">Registro Despacho MP</li>
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="#">Seleccion PC Despacho MP</a> </li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <section class="content">
                        <div class="card">
                            <div class="card-header with-border bg-info">
                                <h4 class="card-title">Selecciona los PC Despacho MP</h4>
                            </div>
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="card-footer">
                                        <div class="btn-group btn-rounded btn-block col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 col-xs-12" role="group" aria-label="Acciones generales">
                                            <button type="button" class="btn btn-success  " data-toggle="tooltip" title="Volver" name="CANCELAR" value="CANCELAR" Onclick="irPagina('registroDespachomp.php?op&id=<?php echo $id_dato; ?>&a=<?php echo $accion_dato; ?>');">
    ...
    if (isset($_REQUEST['SELECIONAREXISTENCIA'])) {
        ...
        echo '<script>
            Swal.fire({
                ...
                location.href = "registroSelecionPCDespachoMP.php?op&id='.$id_dato.'&a='.$accion_dato.'";                            
            })
        </script>';
    }
    if ($SINO == "0") {
        foreach ($SELECIONAREXISTENCIA as $r) :
            ...
            $ARRAYBUSCAREXIMATERIAPRIMA = $EXIMATERIAPRIMA_ADO->verExistenciaPorPCDespacho($IDPCDESPACHO);
            ...
            foreach ($ARRAYBUSCAREXIMATERIAPRIMA as $s) :
                ...
                $EXIMATERIAPRIMA->__SET('ID_DESPACHO', $IDDESPACHOMP);
                $EXIMATERIAPRIMA->__SET('ID_EXIMATERIAPRIMA', $s['ID_EXIMATERIAPRIMA']);
                //LLAMADA AL METODO DE REGISTRO DEL CONTROLADOR
                $EXIMATERIAPRIMA_ADO->actualizarSelecionarDespachoMPCambiarEstado($EXIMATERIAPRIMA);
            ...
            $PCDESPACHOMP->__SET('ID_DESPACHOMP', $IDDESPACHOMP);
            // LLAMADA AL METODO DE REGISTRO DEL CONTROLADOR
            $PCDESPACHOMP_ADO->actualizarPcdespachoADespacho($PCDESPACHOMP);
