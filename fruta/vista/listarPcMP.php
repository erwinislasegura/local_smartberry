...
if ($EMPRESAS  && $PLANTAS && $TEMPORADAS) {
    $ARRAYPCDESPACHO = $PCDESPACHOMP_ADO->listarPcdespachoEmpresaPlantaTemporadaCBX($EMPRESAS, $PLANTAS, $TEMPORADAS);
}
                ...
                <div class="container-full">
                    ...
                    <div class="content-header">
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="page-title">Frigorifico PC MP</h3>
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php"><i class="mdi mdi-home-outline"></i></a></li>
                                            <li class="breadcrumb-item" aria-current="page">Módulo</li>
                                            <li class="breadcrumb-item" aria-current="page">Frigorifico PC MP</li>
                                            <li class="breadcrumb-item" aria-current="page">Planificador Carga MP</li>
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="#"> Agrupado PC MP</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                                ...
                                                <tbody>
                                                    <?php foreach ($ARRAYPCDESPACHO as $r) : ?>
                                                        ...
                                                        if ($r['ESTADO_PCDESPACHO'] == "3") {
                                                            $ESTADODESPACHO =  "En Despacho/Proceso";
                                                        }
                                                        if ($r['ESTADO_PCDESPACHO'] == "4") {
                                                            $ESTADODESPACHO = "Despachado/Procesado";
                                                        }
                                                                    ...
                                                                    <div class="list-icons d-inline-flex">
                                                                        <div class="list-icons-item dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                ...
                                                                                <input type="hidden" class="form-control" placeholder="URL" id="URL" name="URL" value="registroPcMP" />
                                                                                <input type="hidden" class="form-control" placeholder="URL" id="URLO" name="URLO" value="listarPcMP" />
                                                                                <?php if ($r['ESTADO'] == "0") { ?>
