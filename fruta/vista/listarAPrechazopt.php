...
if ($EMPRESAS  && $PLANTAS && $TEMPORADAS) {
    $ARRAYRECHAZO = $RECHAZOPT_ADO->listarRechazoCerrarEmpresaPlantaTemporadaCBX($EMPRESAS, $PLANTAS, $TEMPORADAS);
}
...
<head>
    <title>Rechazo Producto Terminado</title>
                            ...
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"> <a href="#"> Rechazo Producto Terminado </a>  </li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            <form method="post" id="form1">
                                                                ...
                                                                <input type="hidden" class="form-control" placeholder="TABLA" id="TABLA" name="TABLA" value="fruta_rechazopt" />
                                                                <input type="hidden" class="form-control" placeholder="COLUMNA" id="COLUMNA" name="COLUMNA" value="ID_RECHAZO" />
                                                                <input type="hidden" class="form-control" placeholder="TITULO" id="TITULO" name="TITULO" value="Rechazo Producto Terminado" />
                                                                <input type="hidden" class="form-control" placeholder="URL" id="URL" name="URL" value="registroAP" />
                                                                <input type="hidden" class="form-control" placeholder="URL" id="URLO" name="URLO" value="listarAPrechazopt" />
                                                                <?php if ($r['ESTADO'] == "0") { ?>
