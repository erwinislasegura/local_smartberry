            ...
            <script type="text/javascript">
                ...
                function neto() {
                    ...
                    if (repuesta == 0) {
                        ...
                        peso_envase = (CANTIDADENVASE > 0 && neto > 0) ? (neto / CANTIDADENVASE) : 0;
                    }

                    document.getElementById('KILOSNETOV').value = neto;

                    //alert(peso_envase);
                    document.getElementById('KILOSNETODPORENVASEV').value = peso_envase;
...
<body class="hold-transition light-skin fixed sidebar-mini theme-primary sistemRR" >
                            ...
                            <div class="box">
                                ...
                                <div class="box-body ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 col-xs-6" style="<?php if($_GET["urlo_add"]==3){}else{ echo 'display:none;'; } ?>">
                                            <div class="form-group">
                                                <label>Cálculo de Kilos Brutos</label>
                                                <input type="hidden" class="form-control" placeholder="KILOSBRUTOSREALES" id="KILOSBRUTOSREALES" name="KILOSBRUTOSREALES" value="<?php echo $KILOSBRUTOSREALES; ?>" />
                                                <input type="number" class="form-control" placeholder="Kilos Brutos Reales" step="0.01" id="KILOSBRUTOSREALESV" name="KILOSBRUTOSREALESV" style="background-color: #eeeeee;" value="<?php echo $KILOSBRUTOSREALES; ?>" readonly />
                                        ...
                                        <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 col-xs-6" style="<?php if($_GET["urlo_add"]==3){}else{ echo 'display:none;'; } ?>">
                                            <div class="form-group">
                                                <label>Kilos Netos Desh.</label>
                                                <input type="hidden" class="form-control" placeholder="KILOSNETOSDESH" id="KILOSNETOSDESH" name="KILOSNETOSDESH" value="<?php echo $KILOSNETOSDESH; ?>" />
                                                <input type="number" class="form-control" placeholder="Kilos Brutos Reales" step="0.01" id="KILOSNETOSDESHV" name="KILOSNETOSDESHV" value="<?php echo $KILOSNETOSDESH; ?>" oninput="calcularKiloNeto()" />
                                                <label id="val_neto_desh" class="validacion"> </label>
                                            </div>
                                        </div>
                                        
                                        <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 col-xs-6 ">
                                            <div class="form-group">
                                                <label>Kilo Neto Reales</label>
                                         ...
                                         <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 col-xs-6 ">
                                            <div class="form-group">
                                                <label>Kilos Por Envase</label>
                                                <input type="hidden" class="form-control" placeholder="KILOSNETODPORENVASE" id="KILOSNETODPORENVASE" name="KILOSNETODPORENVASE" value="<?php echo $KILOSNETODPORENVASE; ?>" />
                                                <input type="number" class="form-control" placeholder="Kilos Por Envase" step="0.01" id="KILOSNETODPORENVASEV" name="KILOSNETODPORENVASEV" value="<?php echo $KILOSNETODPORENVASE; ?>" disabled style='background-color: #eeeeee;'" />
                                                <label id="val_neto" class="validacion"> </label>
                                            </div>
                                        </div>
    ...
    <!- LLAMADA URL DE ARCHIVOS DE DISEÑO Y JQUERY E OTROS -!>
            ...
            if (isset($_REQUEST['CREAR'])) {
                ...
                if ($SINO == "0") {
                    ...
                    if ($ARRAYVERESTANDAR) {
                        ...
                        if($_GET["urlo_add"]==3){
                            $KILOSNETODRECEPCION = $_REQUEST['KILOSNETODRECEPCION'];
                            $KILOSDESHIDRATACION = $_REQUEST['KILOSNETOSDESHV'];
                            $KILOSBRUTORECEPCION = $_REQUEST['KILOSBRUTOSREALESV'];
                        }else{
        ...
        ?>
<script type="text/javascript">
function calcularKiloNeto() {
    // Obtener el valor de Kilos Netos Desh.
    var kilosNetosDesh = parseFloat(document.getElementById('KILOSNETOSDESHV').value.replace(',', '.')) || 0;
    
    // Obtener el porcentaje de deshidratación del estándar
    var PDESHIDRATACIONEESTANDAR = parseFloat(document.getElementById("PDESHIDRATACIONEESTANDAR").value) || 0;
    
    // Obtener cantidad de envases
    var cantidadEnvase = parseFloat(document.getElementById('CANTIDADENVASE').value.replace(',', '.')) || 0;
    
    // Calcular descuento: 21 + (0.3 * cantidad de envases)
    var descuento = 21 + (0.3 * cantidadEnvase);
    
    // Calcular Kilos Brutos Reales = Kilos Netos Desh. + descuento
    var kilosBrutos = kilosNetosDesh + descuento;
    
    // *** CORRECCIÓN SEGÚN TU IMAGEN ***
    // Kilo Neto Reales = Kilos Netos Desh. / 1.05
    var kiloNeto = kilosNetosDesh / 1.05;
    
    // Asignar valores a los campos con 2 decimales
    document.getElementById('KILOSBRUTOSREALESV').value = kilosBrutos > 0 ? kilosBrutos.toFixed(2) : '0';
    document.getElementById('KILOSNETOV').value = kiloNeto > 0 ? kiloNeto.toFixed(2) : '0';
    document.getElementById('KILOSNETODRECEPCION').value = kiloNeto > 0 ? kiloNeto.toFixed(2) : '0';
    
    // Calcular Kilos Por Envase = Kilo Neto Reales / Cantidad Envases
    var kilosPorEnvase = (cantidadEnvase > 0 && kiloNeto > 0) ? (kiloNeto / cantidadEnvase) : 0;
    
    // Asignar a campo Kilos Por Envase
    var kilosPorEnvaseInput = document.getElementById('KILOSNETODPORENVASEV');
    if (kilosPorEnvaseInput) {
        kilosPorEnvaseInput.value = kilosPorEnvase.toFixed(2);
    }
}
</script>
</body>
