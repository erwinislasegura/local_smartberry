        ...
        <!- FUNCIONES BASES -!>
            <script type="text/javascript">
                ...
                function validacion() {
                    ...
                    NOMBREESPECIES = document.getElementById("NOMBREESPECIES").value;
                    CODIGOSAGESPECIES = document.getElementById("CODIGOSAGESPECIES").value;
                    document.getElementById('val_nombre').innerHTML = "";
                    document.getElementById('val_codigo').innerHTML = "";

                    if (NOMBREESPECIES == null || NOMBREESPECIES.length == 0 || /^\s+$/.test(NOMBREESPECIES)) {
                        document.form_reg_dato.NOMBREESPECIES.focus();
                        document.form_reg_dato.NOMBREESPECIES.style.borderColor = "#FF0000";
                        document.getElementById('val_nombre').innerHTML = "NO A INGRESADO DATO";
                        return false;
                    }
                    document.form_reg_dato.NOMBREESPECIES.style.borderColor = "#4AF575";



                    if (CODIGOSAGESPECIES == null || CODIGOSAGESPECIES.length == 0) {
                        document.form_reg_dato.CODIGOSAGESPECIES.focus();
                        document.form_reg_dato.CODIGOSAGESPECIES.style.borderColor = "#FF0000";
                        document.getElementById('val_codigo').innerHTML = "NO A INGRESADO DATO";
                        return false;
                    }
                    document.form_reg_dato.CODIGOSAGESPECIES.style.borderColor = "#4AF575";
    ...
    <!- LLAMADA URL DE ARCHIVOS DE DISEÑO Y JQUERY E OTROS -!>
        ...
        <?php 
            ...
            if (isset($_REQUEST['GUARDAR'])) {
                ...
                $AUSUARIO_ADO->agregarAusuario2("NULL",2,1,"".$_SESSION["NOMBRE_USUARIO"].", Registro de Especies.","fruta_especies","NULL",$_SESSION["ID_USUARIO"],$_SESSION['ID_EMPRESA'], $_SESSION['ID_PLANTA'],$_SESSION['ID_TEMPORADA'] );  
            ...
            if (isset($_REQUEST['EDITAR'])) {
                ...
                $AUSUARIO_ADO->agregarAusuario2("NULL",2,2,"".$_SESSION["NOMBRE_USUARIO"].", Modificación de Especies.","fruta_especies", $_REQUEST['ID'],$_SESSION["ID_USUARIO"],$_SESSION['ID_EMPRESA'], $_SESSION['ID_PLANTA'],$_SESSION['ID_TEMPORADA'] );     
            ...
            if (isset($_REQUEST['ELIMINAR'])) {         
                ...
                $AUSUARIO_ADO->agregarAusuario2("NULL",2,4,"".$_SESSION["NOMBRE_USUARIO"].", Deshabilitar  Especies.","fruta_especies", $_REQUEST['ID'],$_SESSION["ID_USUARIO"],$_SESSION['ID_EMPRESA'], $_SESSION['ID_PLANTA'],$_SESSION['ID_TEMPORADA'] );                
            ...
            if (isset($_REQUEST['HABILITAR'])) {   
                ...
                $AUSUARIO_ADO->agregarAusuario2("NULL",2,5,"".$_SESSION["NOMBRE_USUARIO"].", Habilitar  Especies.","fruta_especies", $_REQUEST['ID'],$_SESSION["ID_USUARIO"],$_SESSION['ID_EMPRESA'], $_SESSION['ID_PLANTA'],$_SESSION['ID_TEMPORADA'] );                               
