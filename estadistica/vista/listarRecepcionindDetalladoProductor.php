...
$ARRAYEMPRESAPRODUCTOR = filtrarPorEmpresa($ARRAYEMPRESAPRODUCTOR, $EMPRESAS);
...
<body class="hold-transition light-skin fixed sidebar-mini theme-primary" >
    <div class="wrapper">
        ...
        $ARRAYRECEPCIONIND = $RECEPCIONIND_ADO->listarRecepcionEmpresaPlantaTemporadaCBXProductor($a["ID_EMPRESA"], $a["ID_PRODUCTOR"], $TEMPORADAS, $ESPECIE);

                                                foreach ($ARRAYRECEPCIONIND as $r) : ?>
                                                    ...
                                                    <?php foreach ($ARRAYTOMADO as $s) : ?>
                                                        ...
                                                        // Verificar si la especie coincide con la de la sesión
