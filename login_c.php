                ...
                <div class="tab-content" id="loginTabContent">
                    <div class="tab-pane fade show active" id="fruta" role="tabpanel" aria-labelledby="fruta-tab" style="border: solid 1px rgba(0,0,0,0.1); padding: 10px;">
                        ...
                        <form class="form" role="form" id="loginForm_fruta" name="form_reg_dato">
                            ...
                            <div class="form-check mb-3" style="display:flex; align-items:center; gap:8px; font-size:12px; color:#333;">
                                <input class="form-check-input" type="checkbox" value="1" id="PRECARGA_EXPORTACION_FRUTA" style="margin-top:0;">
                                <label class="form-check-label" for="PRECARGA_EXPORTACION_FRUTA" style="margin-bottom:0;">
                                    Cargar información pesada en segundo plano
                                </label>
                            </div>
                            <div class="row">
                                <div class="col-12">
                    ...
                    <div class="tab-pane fade" id="materiales" role="tabpanel" aria-labelledby="materiales-tab" style="border: solid 1px rgba(0,0,0,0.1); padding: 10px;">
                        ...
                        <form class="form" role="form" id="loginForm_material" name="form_reg_dato">
                            ...
                            <div class="form-check mb-3" style="display:flex; align-items:center; gap:8px; font-size:12px; color:#333;">
                                <input class="form-check-input" type="checkbox" value="1" id="PRECARGA_EXPORTACION_MATERIAL" style="margin-top:0;">
                                <label class="form-check-label" for="PRECARGA_EXPORTACION_MATERIAL" style="margin-bottom:0;">
                                    Cargar información pesada en segundo plano
                                </label>
                            </div>
                            <div class="row">
                    ...
                    <div class="tab-pane fade" id="exportadora" role="tabpanel" aria-labelledby="exportadora-tab" style="border: solid 1px rgba(0,0,0,0.1); padding: 10px;">
                        ...
                        <form class="form" role="form" id="loginForm_exportadora" name="form_reg_dato">
                            ...
                            <div class="form-check mb-3" style="display:flex; align-items:center; gap:8px; font-size:12px; color:#333;">
                                <input class="form-check-input" type="checkbox" value="1" id="PRECARGA_EXPORTACION_EXPORTADORA" style="margin-top:0;">
                                <label class="form-check-label" for="PRECARGA_EXPORTACION_EXPORTADORA" style="margin-bottom:0;">
                                    Cargar información pesada en segundo plano
                                </label>
                            </div>
                            <div class="row">
