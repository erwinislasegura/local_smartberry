        ...
        <!- FUNCIONES BASES -!>
            <script type="text/javascript">
                ...
                function validacion() {
                    ...
                    NOMBRETUSUARIO = document.getElementById("NOMBRETUSUARIO").value;


                    document.getElementById('val_nombre').innerHTML = "";


                    if (NOMBRETUSUARIO == null || NOMBRETUSUARIO.length == 0 || /^\s+$/.test(NOMBRETUSUARIO)) {
                        document.form_reg_dato.NOMBRETUSUARIO.focus();
                        document.form_reg_dato.NOMBRETUSUARIO.style.borderColor = "#FF0000";
                        document.getElementById('val_nombre').innerHTML = "NO A INGRESADO DATO";
                        return false;
                    }
                    document.form_reg_dato.NOMBRETUSUARIO.style.borderColor = "#4AF575";
                ...
                <div class="container-full">
                    ...
                    <div class="content-header">
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="page-title">Tipo Usuario</h3>
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="#">Tipo Usuario </a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                            ...
                                            <div class="row">
                                                 <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder=" Nombre Tipo Usuario" id="NOMBRETUSUARIO" name="NOMBRETUSUARIO" value="<?php echo $NOMBRETUSUARIO; ?>" <?php echo $FOCUS; ?> <?php echo  $BORDER; ?> <?php echo $DISABLED; ?> />
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-xs-12">
                                <div class="box">
                                    <div class="box-header with-border bg-info">
                                        <h4 class="box-title">Agrupado Tipo Usuario</h4>
                                    </div>
                                    <div class="box-body">
                                                        ...
                                                        <tr class="center">
                                                            <td>
                                                                <a href="#" class="text-warning hover-warning">
                                                                    <?php echo $r['ID_TUSUARIO']; ?>
                                                                </a>
                                                            </td>
                                                            <td> <?php echo $r['NOMBRE_TUSUARIO']; ?></td>                                                                                                                                                                      
                                                                    ...
                                                                    <div class="list-icons d-inline-flex">
                                                                        <div class="list-icons-item dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <input type="hidden" class="form-control" placeholder="ID" id="ID" name="ID" value="<?php echo $r['ID_TUSUARIO']; ?>" />
                                                                                <input type="hidden" class="form-control" placeholder="URL" id="URL" name="URL" value="registroTusuario" />
            ...
            if (isset($_REQUEST['GUARDAR'])) {
                ...
                //REDIRECCIONAR A PAGINA registroEcomercial.php
                            ...
                            Swal.fire({
                                ...
                                text:"El registro de Tipo Usuario se ha creado correctamente",
            ...
            if (isset($_REQUEST['EDITAR'])) {
                ...
                //REDIRECCIONAR A PAGINA registroEcomercial.php
                        ...
                        Swal.fire({
                            ...
                            text:"El registro de Tipo Usuario se ha modificado correctamente",
                            showConfirmButton: true,
                            confirmButtonText:"Cerrar",
                            closeOnConfirm:false
                        }).then((result)=>{
