...
$ARRAYTETIQUETA = $TETIQUETA_ADO->listarEtiquetaPorEmpresaCBX($EMPRESAS);
        ...
        <!- FUNCIONES BASES -!>
            <script type="text/javascript">
                ...
                function validacion() {
                    ...
                    NOMBRETETIQUETA = document.getElementById("NOMBRETETIQUETA").value;
                    document.getElementById('val_nombre').innerHTML = "";

                    if (NOMBRETETIQUETA == null || NOMBRETETIQUETA.length == 0 || /^\s+$/.test(NOMBRETETIQUETA)) {
                        document.form_reg_dato.NOMBRETETIQUETA.focus();
                        document.form_reg_dato.NOMBRETETIQUETA.style.borderColor = "#FF0000";
                        document.getElementById('val_nombre').innerHTML = "NO A INGRESADO DATO";
                        return false;
                    }
                    document.form_reg_dato.NOMBRETETIQUETA.style.borderColor = "#4AF575";
                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="#"> Registro Etiqueta </a> </li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nombre Etiqueta" id="NOMBRETETIQUETA" name="NOMBRETETIQUETA" value="<?php echo $NOMBRETETIQUETA; ?>" <?php echo $DISABLED; ?> />
                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive">
                                            <table id="listar" class=" table-hover " style="width: 100%;">
                                                ...
                                                <tbody>
                                                    <?php foreach ($ARRAYTETIQUETA as $r) : ?>
                                                        <?php 
                                                            $CONTADOR+=1;  
                                                        ?>
                                                        <tr class="center">
                                                                    ...
                                                                    <div class="list-icons d-inline-flex">
                                                                        <div class="list-icons-item dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <input type="hidden" class="form-control" placeholder="ID" id="ID" name="ID" value="<?php echo $r['ID_TETIQUETA']; ?>" />
                                                                                <input type="hidden" class="form-control" placeholder="URL" id="URL" name="URL" value="registroTetiqueta" />
                                                            ...
                                                            <td><?php echo $r['NOMBRE_TETIQUETA']; ?></td>   
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
    ...
    <!- LLAMADA URL DE ARCHIVOS DE DISEÑO Y JQUERY E OTROS -!>
        ...
        <?php 
            ...
            if (isset($_REQUEST['GUARDAR'])) {
                ...
                $ARRAYNUMERO = $TETIQUETA_ADO->obtenerNumero($_REQUEST['EMPRESA']);
                $NUMERO = $ARRAYNUMERO[0]['NUMERO'] + 1;


                //UTILIZACION METODOS SET DEL MODELO
                //SETEO DE ATRIBUTOS DE LA CLASE, OBTENIDO EN EL FORMULARIO   
                $TETIQUETA->__SET('NUMERO_TETIQUETA', $NUMERO);
                $TETIQUETA->__SET('NOMBRE_TETIQUETA', $_REQUEST['NOMBRETETIQUETA']);
                $TETIQUETA->__SET('ID_EMPRESA', $_REQUEST['EMPRESA']);
                $TETIQUETA->__SET('ID_USUARIOI', $IDUSUARIOS);
