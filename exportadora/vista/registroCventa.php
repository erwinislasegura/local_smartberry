...
if (isset($id_dato) && isset($accion_dato)) {
    ...
    $ARRAYCVENTAID = $CVENTA_ADO->verCventa($IDOP);
    ...
    if ($OP == "0") {
        ...
        foreach ($ARRAYCVENTAID as $r) :
            $NOMBRECVENTA = "" . $r['NOMBRE_CVENTA'];
            $NOTACVENTA = "" . $r['NOTA_CVENTA'];
        endforeach;
                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="registroCventa.php"> Registro Clausula Venta</a>  </li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                    ...
                                    <form class="form" role="form" method="post" name="form_reg_dato" id="form_reg_dato" >
                                        ...
                                        <div class="box-footer">
                                            <div class="btn-group   col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 col-xs-12 " role="group" aria-label="Acciones generales">                                    
                                                <button type="button" class="btn  btn-warning " data-toggle="tooltip" title="Cancelar" name="CANCELAR" value="CANCELAR" Onclick="irPagina('registroCventa.php');">
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-xs-12">
                                <div class="box">
                                    <div class="box-header with-border bg-info">
                                        <h4 class="box-title">Agrupados Clausula Venta</h4>
                                    </div>
                                    <div class="box-body">
                                                                    ...
                                                                    <div class="list-icons d-inline-flex">
                                                                        <div class="list-icons-item dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <input type="hidden" class="form-control" placeholder="ID" id="ID" name="ID" value="<?php echo $r['ID_CVENTA']; ?>" />
                                                                                <input type="hidden" class="form-control" placeholder="URL" id="URL" name="URL" value="registroCventa" />
    ...
    <!- LLAMADA URL DE ARCHIVOS DE DISEÑO Y JQUERY E OTROS -!>
        ...
        <?php 
            ...
            if (isset($_REQUEST['GUARDAR'])) {
                ...
                $AUSUARIO_ADO->agregarAusuario2("NULL",3,1,"".$_SESSION["NOMBRE_USUARIO"].", Registro de Clausula Venta.","fruta_cventa","NULL",$_SESSION["ID_USUARIO"],$_SESSION['ID_EMPRESA'],'NULL',$_SESSION['ID_TEMPORADA'] );  
                ...
                //REDIRECCIONAR A PAGINA registroTfruta.php
                    ...
                    Swal.fire({
                        ...
                        location.href = "registroCventa.php";                            
                    })
                </script>';
            }
            ...
            if (isset($_REQUEST['EDITAR'])) {
                ...
                $CVENTA->__SET('NOTA_CVENTA', $_REQUEST['NOTACVENTA']);
                $CVENTA->__SET('ID_USUARIOM', $IDUSUARIOS);
                $CVENTA->__SET('ID_CVENTA', $_REQUEST['ID']);
                //LLAMADA AL METODO DE EDICION DEL CONTROLADOR
                $CVENTA_ADO->actualizarCventa($CVENTA);

                $AUSUARIO_ADO->agregarAusuario2("NULL",3,2,"".$_SESSION["NOMBRE_USUARIO"].", Modificación de Clausula  Venta.","fruta_cventa", $_REQUEST['ID'],$_SESSION["ID_USUARIO"],$_SESSION['ID_EMPRESA'],'NULL',$_SESSION['ID_TEMPORADA'] );     
            ...
            if (isset($_REQUEST['ELIMINAR'])) {     
                ...
                $CVENTA->__SET('ID_CVENTA', $_REQUEST['ID']);
                $CVENTA_ADO->deshabilitar($CVENTA);
        

                $AUSUARIO_ADO->agregarAusuario2("NULL",3,4,"".$_SESSION["NOMBRE_USUARIO"].", Deshabilitar Clausula  Venta.","fruta_cventa", $_REQUEST['ID'],$_SESSION["ID_USUARIO"],$_SESSION['ID_EMPRESA'],'NULL',$_SESSION['ID_TEMPORADA'] );                
            ...
            if (isset($_REQUEST['HABILITAR'])) {   
                ...
                $CVENTA->__SET('ID_CVENTA',  $_REQUEST['ID']);
                $CVENTA_ADO->habilitar($CVENTA);

                $AUSUARIO_ADO->agregarAusuario2("NULL",3,5,"".$_SESSION["NOMBRE_USUARIO"].", Habilitar Clausula  Venta.","fruta_cventa", $_REQUEST['ID'],$_SESSION["ID_USUARIO"],$_SESSION['ID_EMPRESA'],'NULL',$_SESSION['ID_TEMPORADA'] );                               
