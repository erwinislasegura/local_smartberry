...
if ($EMPRESAS  && $TEMPORADAS) {
    $ARRAYEXIEXPORTACION = $EXIEXPORTACION_ADO->listarExiexportacionAgrupadoPorFolioEmpresaTemporadaParaCambioIcarga($EMPRESAS,  $TEMPORADAS);
}
                                            ...
                                            <table id="hexistencia" class="table-hover" style="width: 300%;">
                                                ...
                                                <tbody>
                                                    <?php foreach ($ARRAYEXIEXPORTACION as $s) : ?>
                                                        <?php $ARRAYEXISTENCIA=$EXIEXPORTACION_ADO->listarExiexportacionEmpresaTemporadaPorFolioParaCambiaIcarga($EMPRESAS,  $TEMPORADAS,$s['FOLIO_AUXILIAR_EXIEXPORTACION'] );  ?>                                                                                                                    
                                                                        ...
                                                                        <div class="list-icons d-inline-flex">
                                                                            <div class="list-icons-item dropdown">
                                                                                ...
                                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                                    ...
                                                                                    <input type="hidden" class="form-control" placeholder="URL" id="URL" name="URL" value="registroCambiarIcargaD" />
                                                                                    <input type="hidden" class="form-control" placeholder="URL" id="URLO" name="URLO" value="registroCambiarIcarga" />
                                                                                    <span href="#" class="dropdown-item" data-toggle="tooltip" title="Cambiar Folio">
                                                                                        <button type="submit" class="btn btn-warning btn-block " id="CAMBIARFOLIO" name="CAMBIARFOLIO">
                                                                                            <i class="ti-exchange-vertical"></i>  Cambiar Instr. Carga                                                                                      
                                                                                        </button>
                                                                                    </span>
                                                                                </div>
                                                                            </div>
