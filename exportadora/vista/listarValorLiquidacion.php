...
if ($EMPRESAS   && $TEMPORADAS) {
    ...
    $ARRAYTITEMPAGO = $TITEM_ADO->listarTitemPorEmpresaLiquidacionCBX($EMPRESAS);
...
<head>
    <title>Agrupado Valor Liquidación</title>
                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="#">Registro Valor Liquidación </a> </li>                                    
                                        </ol>
                                </nav>
                            </div>
                        </div>
                                            ...
                                            <thead>
                                                <tr class="text-center">
                                                    ...
                                                    <?php foreach ($ARRAYTITEMPAGO as $d) : ?>
                                                        <th><?php echo "Liqui.: <br>".$d["NOMBRE_TITEM"]; ?></th>     
                                                    <?php endforeach; ?>            
                                                    <th>Total<br> Liqui.</th>         
                                                </tr>
                                            </thead>
                                            <tbody>
                                                                ...
                                                                <div class="list-icons d-inline-flex">
                                                                    <div class="list-icons-item dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            ...
                                                                            <input type="hidden" class="form-control" placeholder="URL" id="URL" name="URL" value="registroValorLiquidacion" />
                                                                            <input type="hidden" class="form-control" placeholder="URL" id="URLO" name="URLO" value="listarValorLiquidacion" />
                                                                            <?php if ($r['ESTADO'] == "0") { ?>
