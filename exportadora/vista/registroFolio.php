...
$ARRAYFOLIO = $FOLIO_ADO->buscarFoliPorEmpresa($EMPRESAS, $_SESSION['ID_TEMPORADA']);
        ...
        <!- FUNCIONES BASES -!>
            <script type="text/javascript">
                ...
                function validacion() {
                    ...
                    document.getElementById('val_empresae').innerHTML = "";
                    ...
                    if (EMPRESA == null || EMPRESA == 0) {
                        ...
                        document.getElementById('val_empresae').innerHTML = "NO HA SELECCIONADO  NINGUNA ALTERNATIVA";
                        return false;
                    }
                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="#"> Registro Folio </a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" id="EMPRESA" name="EMPRESA" style="width: 100%;" value="<?php echo $EMPRESA; ?>" <?php echo $DISABLED; ?>>
                                                            ...
                                                            <?php foreach ($ARRAYEMPRESA as $r) : ?>
                                                                <?php if ($ARRAYEMPRESA) {    ?>
                                                                    <option value="<?php echo $r['ID_EMPRESA']; ?>" 
                                                                        <?php if ($EMPRESA == $r['ID_EMPRESA']) { echo "selected"; } ?>>
                                                        ...
                                                        <label id="val_empresae" class="validacion"> </label>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 col-xs-6">   
                                                    <div class="form-group">
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 col-xs-6">   
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" id="TFOLIO" name="TFOLIO" style="width: 100%;" value="<?php echo $TFOLIO; ?>" <?php echo $DISABLED; ?>>
                                                            <option></option>
                                                            <option value="1" <?php if ($TFOLIO == 1) { echo "selected"; } ?>>
                                                                Materia Prima
                                                            </option>
                                                            <option value="2" <?php if ($TFOLIO == 2) { echo "selected"; } ?>>
                                                                Exportacion
                                                            </option>
                                                            <option value="3" <?php if ($TFOLIO == 3) { echo "selected"; } ?>>
                                                                Industrial
                                                            </option>
                                                        </select>
                                                        ...
                                                        <select class="form-control select2" id="TEMPORADA" name="TEMPORADA" style="width: 100%;" value="<?php echo $TEMPORADA; ?>" <?php echo $DISABLED; ?>>
                                                            ...
                                                            <?php foreach ($ARRAYTEMPORADA as $r) : ?>
                                                                <?php if ($ARRAYTEMPORADA) {    ?>
                                                                    <option value="<?php echo $r['ID_TEMPORADA']; ?>" 
                                                                    <?php if ($TEMPORADA == $r['ID_TEMPORADA']) { echo "selected"; } ?>>
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-xs-12">
                                <div class="box">
                                    <div class="box-header with-border bg-info">
                                        <h4 class="box-title"> Agrupado Folios Fruta</h4>
                                    </div>
                                    <div class="box-body">
