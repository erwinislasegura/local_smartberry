                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="#"> Registro Mercado </a> </li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-xs-12">
                                <div class="box">
                                    <div class="box-header with-border bg-info">
                                        <h4 class="box-title">Agrupados Mercado</h4>
                                    </div>
                                    <div class="box-body">
                                                ...
                                                <tbody>
                                                    <?php foreach ($ARRAYMERCADO as $r) : ?>
                                                        ...
                                                        <tr class="center">
                                                                    ...
                                                                    <div class="list-icons d-inline-flex">
                                                                        <div class="list-icons-item dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <input type="hidden" class="form-control" placeholder="ID" id="ID" name="ID" value="<?php echo $r['ID_MERCADO']; ?>" />
                                                                                <input type="hidden" class="form-control" placeholder="URL" id="URL" name="URL" value="registroMercado" />
                                                            ...
                                                            <td> <?php echo $r['NOMBRE_MERCADO']; ?> </td>   
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
