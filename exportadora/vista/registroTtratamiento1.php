...
//INIICIALIZAR MODELO
$TTRATAMIENTO1 =  new TTRATAMIENTO1();
...
if (isset($id_dato) && isset($accion_dato)) {
    ...
    if ($OP == "0") {
        ...
        $ARRAYTTRATAMIENTOID = $TTRATAMIENTO1_ADO->verTtratamiento($IDOP);
...
<head>
    <title>Registro Tipo Tratamiento 1 </title>
                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="#">Registro Tipo Tratamiento 1 </a>  </li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-xs-12">
                                <div class="box">
                                    <div class="box-header with-border bg-primary">                               
                                        <h4 class="box-title">Registro Tipo Tratamiento 1 </h4>                                     
                                    </div>
                                    <!-- /.box-header -->
                                    <form class="form" role="form" method="post" name="form_reg_dato" id="form_reg_dato" >
                                        ...
                                        <div class="box-footer">
                                            <div class="btn-group   col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 col-xs-12 " role="group" aria-label="Acciones generales">                                    
                                                <button type="button" class="btn  btn-warning " data-toggle="tooltip" title="Cancelar" name="CANCELAR" value="CANCELAR" Onclick="irPagina('registroTtratamiento1.php');">
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-xs-12">
                                <div class="box">
                                    <div class="box-header with-border bg-info">
                                        <h4 class="box-title">Agrupados Tipo Tratamiento 1</h4>
                                    </div>
                                    <div class="box-body">
    ...
    <!- LLAMADA URL DE ARCHIVOS DE DISEÑO Y JQUERY E OTROS -!>
        ...
        <?php
            ...
            if (isset($_REQUEST['GUARDAR'])) {
                ...
                $TTRATAMIENTO1_ADO->agregarTtratamiento($TTRATAMIENTO1);

                $AUSUARIO_ADO->agregarAusuario2("NULL",3,1,"".$_SESSION["NOMBRE_USUARIO"].", Registro de Tipo Tratamiento 1.","fruta_tratamineto1","NULL",$_SESSION["ID_USUARIO"],$_SESSION['ID_EMPRESA'],'NULL',$_SESSION['ID_TEMPORADA'] );  
                ...
                //REDIRECCIONAR A PAGINA registroTtratamiento1.php
                    echo '<script>
                        Swal.fire({
                            ...
                            location.href = "registroTtratamiento1.php";                            
                        })
                    </script>';
            }
            ...
            if (isset($_REQUEST['EDITAR'])) {
                ...
                $TTRATAMIENTO1_ADO->actualizarTtratamiento($TTRATAMIENTO1);

                $AUSUARIO_ADO->agregarAusuario2("NULL",3,2,"".$_SESSION["NOMBRE_USUARIO"].", Modificación de Tipo Tratamiento 1.","fruta_tratamineto1", $_REQUEST['ID'],$_SESSION["ID_USUARIO"],$_SESSION['ID_EMPRESA'],'NULL',$_SESSION['ID_TEMPORADA'] );     
            ...
            if (isset($_REQUEST['ELIMINAR'])) {         
                ...
                $TTRATAMIENTO1->__SET('ID_TTRATAMIENTO', $_REQUEST['ID']);
                $TTRATAMIENTO1_ADO->deshabilitar($TTRATAMIENTO1);                    


                $AUSUARIO_ADO->agregarAusuario2("NULL",3,4,"".$_SESSION["NOMBRE_USUARIO"].", Deshabilitar Tipo Tratamiento 1.","fruta_tratamineto1", $_REQUEST['ID'],$_SESSION["ID_USUARIO"],$_SESSION['ID_EMPRESA'],'NULL',$_SESSION['ID_TEMPORADA'] );                
            ...
            if (isset($_REQUEST['HABILITAR'])) {       
                ...
                $TTRATAMIENTO1->__SET('ID_TTRATAMIENTO',  $_REQUEST['ID']);
                $TTRATAMIENTO1_ADO->habilitar($TTRATAMIENTO1);

                $AUSUARIO_ADO->agregarAusuario2("NULL",3,5,"".$_SESSION["NOMBRE_USUARIO"].", Habilitar Tipo Tratamiento 1.","fruta_tratamineto1", $_REQUEST['ID'],$_SESSION["ID_USUARIO"],$_SESSION['ID_EMPRESA'],'NULL',$_SESSION['ID_TEMPORADA'] );                               
